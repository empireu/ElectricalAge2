...
class GridPoleBlock(val delegateMap: MultiblockDelegateMap, val attachment: Vector3d, private val cellProvider: RegistryObject<CellProvider<GridAnchorCell>>) : UprightHorizontalDirectionCellBlock<GridAnchorCell>() {
